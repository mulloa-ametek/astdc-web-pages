...
<xsl:stylesheet version="1.0"
	...
	*************************************************************************************-->
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<xsl:element name="body">
				...
				<div id="main_content">
					...
					<div id="form_data">
						<form method="post" action="configuration.cgi">
							...
							<table id="configuration_table">
								...
								<xsl:call-template name="table_edit_box_entry">
									...
									<!-- we are restricted to 16 characters for the host name, so that makes 7 included null character -->
								...
								<tr>
									...
									<td>
										...
										<xsl:choose>
											<xsl:when test="$dhcp_enabled = 'true'">
										...
										<xsl:otherwise>
												<label><input name="address_configuration" type="radio" value="dhcp" onclick="enable_optional_content(true);"/>DHCP</label>
												<label><input name="address_configuration" type="radio" value="static_ip" checked="checked" onclick="enable_optional_content(false);"/>Static IP</label>
										</xsl:otherwise>
										</xsl:choose>
									</td>
								</tr>
	...
	<xsl:template name="table_edit_box_entry">
		...
		<!-- optional parameter to restrict length -->
