	...
	<xsl:template match="lxi:LXIDevice">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<link href="/interactive_layout.css" rel="stylesheet" type="text/css" />
			...
			<body>
					...
					<div id="button_div">
						<ul id="button_list">
							...
							<li id="interactive_control_element">
								<a id="interactive_button" class="selected_header_button" href="/cgi-bin/interactive.cgi">Interactive Control</a>
							</li>
				...
				<div id="main_content">
					...
					<div>
						Command:
						<input id="command_text" type="text" size="50"/>
						<input type="button" value="Send Command" onclick="send_button_click()"/>
					</div>
				</div>
