<xsl:stylesheet version="1.0"
	...
	*************************************************************************************-->
	...
	<xsl:template match="lxi:LXIDevice">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<link href="/module_layout.css" rel="stylesheet" type="text/css" />
			</head>
			<body>
				...
				<div id="header">
					...
					<div id="button_div">
						<ul id="button_list">
							...
							<li id="module_element">
								<a id="module_button" class="selected_header_button" href="/cgi-bin/module.cgi">Modules</a>
							</li>
						</ul>
					</div>
				</div>
	...
	<xsl:template name="formatted_name">
		...
		<xsl:call-template name="short_model_name"/>
		<xsl:text>-</xsl:text>
		<xsl:call-template name="voltage_current"/>
		<xsl:text>-</xsl:text>
